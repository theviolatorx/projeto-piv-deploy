...
def cs_sidebar():
    ...
    st.sidebar.markdown('''[<img src='data:image/png;base64,{}' class='img-fluid' width=162 height=auto>](https://streamlit.io/)'''.format(
        img_to_bytes("logo-univesp-white.png")), unsafe_allow_html=True)
...
def cs_body():
    ...
    with col1:
        ...
        antenas = pd.read_csv('data/lista-das-antenas-mobile-brasil.csv')
